...
class AppConfig {
  ...
  /// IP instead, e.g. `http://192.168.1.23:8090`).
  ///
  ...
  /// dev server exposed at host port 8090 — see P-000's port table in
  /// PROJECT_PROGRESS.md):
  ...
  static const int _devBackendPort = 8090;
  ...
  static String get _devDefaultBaseUrl {
    ...
    if (Platform.isAndroid) {
      ...
      // --dart-define=API_BASE_URL=http://<host-lan-ip>:8090 override.
